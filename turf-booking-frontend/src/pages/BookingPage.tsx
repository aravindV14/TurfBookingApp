...
const BookingPage: React.FC = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <input type="datetime-local" value={slotStart} onChange={(e) => setSlotStart(e.target.value)} style={styles.input} />
      <label style={styles.label}>End Time:</label>
      <input type="datetime-local" value={slotEnd} onChange={(e) => setSlotEnd(e.target.value)} style={styles.input} />
